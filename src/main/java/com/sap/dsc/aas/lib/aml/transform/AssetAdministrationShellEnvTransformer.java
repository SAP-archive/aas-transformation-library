...
import com.sap.dsc.aas.lib.aml.config.pojo.ConfigAssetShell;
...
public class AssetAdministrationShellEnvTransformer extends AbstractTransformer {
     ...
     */
    protected AssetAdministrationShellEnvironment createShellEnv(Document document, List<ConfigMapping> configMappings)
