...
/**
 * Context Object which provides a Context Item and Defintions and Variables
 * defines so far.
 * 
 * @author br-iosb
 *
...
public class TransformationContext {
	 ...
	 * 
	 * @param parentCtx TransformationContext to inherit Variables and Definitions
	 *                  from, might be null if nothing is to inherit from
	 * @param ctxItem   usually the current scope (e.g. result of @foreach) in which Expressions will be executed
	 * @param template  Template which might contain new Variables and Definitions,
	 *                  might be null
